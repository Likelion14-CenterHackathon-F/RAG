...
SOURCES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "end_markers": ["Next:", "Table of Contents"],
    },
    {
    ...
    {
        "slug": "tas_eyelid_recovery",
        "title": "The Aesthetic Society eyelid surgery aftercare and recovery",
        "institution": "The Aesthetic Society",
        "source_type": "professional_patient_guidance",
        "url": "https://www.theaestheticsociety.org/procedures/head-face/eyelid-surgery/aftercare-recovery",
        "recommended_use": "눈성형(쌍꺼풀·안검) 후 냉찜질, 인공눈물, 활동 제한, 실밥 제거, 시야 이상 시 즉시 진료",
        "department": "oculoplasty",
        "procedure": "blepharoplasty",
        "html_file": "tas_eyelid_recovery.html",
        "start_markers": ["How long does it take to recover from eyelid surgery?"],
        "end_markers": ["Overview"],
    },
    {
        "slug": "tas_facelift_recovery",
        "title": "The Aesthetic Society facelift aftercare and recovery",
        "institution": "The Aesthetic Society",
        "source_type": "professional_patient_guidance",
        "url": "https://www.theaestheticsociety.org/procedures/head-face/facelift/aftercare-recovery",
        "recommended_use": "안면 리프팅 후 부기·멍 경과, 배액관, 세안, 활동 재개, 경과 관찰 기준",
        "department": "plastic_surgery",
        "procedure": "facelift",
        "html_file": "tas_facelift_recovery.html",
        "start_markers": ["How long does it take to recover from a facelift?"],
        "end_markers": ["Overview"],
    },
    {
        "slug": "tas_brow_lift_recovery",
        "title": "The Aesthetic Society brow lift aftercare and recovery",
        "institution": "The Aesthetic Society",
        "source_type": "professional_patient_guidance",
        "url": "https://www.theaestheticsociety.org/procedures/head-face/brow-lift/aftercare-recovery",
        "recommended_use": "이마·눈썹 리프팅 후 부기, 활동 제한, 운동 재개 기준",
        "department": "plastic_surgery",
        "procedure": "brow_lift",
        "html_file": "tas_brow_lift_recovery.html",
        "start_markers": ["How long does it take to recover from a brow lift procedure?"],
        "end_markers": ["Overview"],
    },
    {
        "slug": "tas_neck_lift_recovery",
        "title": "The Aesthetic Society neck lift aftercare and recovery",
        "institution": "The Aesthetic Society",
        "source_type": "professional_patient_guidance",
        "url": "https://www.theaestheticsociety.org/procedures/head-face/neck-lift/aftercare-recovery",
        "recommended_use": "목 리프팅 후 회복 기간, 절개부 관리, 메이크업 재개 시점",
        "department": "plastic_surgery",
        "procedure": "neck_lift",
        "html_file": "tas_neck_lift_recovery.html",
        "start_markers": ["How long does it take to recover from a neck lift?"],
        "end_markers": ["Overview"],
    },
    {
        "slug": "asps_thread_lift",
        "title": "American Society of Plastic Surgeons thread lift",
        "institution": "American Society of Plastic Surgeons",
        "source_type": "professional_patient_guidance",
        "url": "https://www.plasticsurgery.org/cosmetic-procedures/thread-lift",
        "recommended_use": "실리프팅 개요와 적합 대상, 시술 후 기대 범위",
        "department": "plastic_surgery",
        "procedure": "thread_lift",
        "html_file": "asps_thread_lift.html",
        "start_markers": ["What is a thread lift?"],
        "end_markers": ["Next:", "Table of Contents"],
    },
    {
        "slug": "tas_eyelid_safety",
        "title": "The Aesthetic Society eyelid surgery risks and safety",
        "institution": "The Aesthetic Society",
        "source_type": "professional_patient_guidance",
        "url": "https://www.theaestheticsociety.org/procedures/head-face/eyelid-surgery/safety-considerations",
        "recommended_use": "눈성형 중대 위험 신호. hard-stop 룰 근거 후보",
        "department": "oculoplasty",
        "procedure": "blepharoplasty",
        "html_file": "tas_eyelid_safety.html",
        "start_markers": ["What risks are there with getting eyelid surgery?"],
        "end_markers": ["Overview"],
    },
    {
        "slug": "tas_facelift_safety",
        "title": "The Aesthetic Society facelift risks and safety",
        "institution": "The Aesthetic Society",
        "source_type": "professional_patient_guidance",
        "url": "https://www.theaestheticsociety.org/procedures/head-face/facelift/safety-considerations",
        "recommended_use": "안면 리프팅 중대 위험 신호. hard-stop 룰 근거 후보",
        "department": "plastic_surgery",
        "procedure": "facelift",
        "html_file": "tas_facelift_safety.html",
        "start_markers": ["What are the risks associated with facelift surgery?"],
        "end_markers": ["Overview"],
    },
